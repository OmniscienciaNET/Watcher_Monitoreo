...
function ConfigurarExit() {
    ...
    document.getElementById("btnExit").onclick = function () {
        ...
        $("#myModalConfirm").on("hide.bs.modal", function () { });
        document.getElementById("btnExit").setAttribute("data-target", "#myModalConfirm");
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data != "") {
                                ...
                                Habilitar();
                                timerAlarmasEvento = setInterval("HistorialEvento()", 15000);
                            }
                        },
                        error: error
                    });
            ...
            if (rpta.Data.length == 0) {
                ...
                for (var i = 0; i < rpta.Data.length; i++) {
                    ...
                    $("#btnAssign" + i).click({ obj: rpta.Data[i] }, function (event) {
                        //alert(event.data.obj.AlarmHistoryID);
                        //alert(prueba);
                        $.ajax({
                            type: "post",
                            url: "../Modulo/AsignarAlarma",
                            ...
                            data: "{AlarmHistoryID:" + event.data.obj.AlarmHistoryID + ", user:'" + prueba + "'}",
                            dataType: "json",
                            success: function (data) {
                                if (data != "") {                                    
                                    alert(data);
